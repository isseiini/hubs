...
AFRAME.registerComponent("virtual-gamepad-controls", {
  ...
  init() {
    ...
    this.enableLeft = true; //window.APP.store.state.preferences.enableOnScreenJoystickLeft;
    this.enableRight = true; //window.APP.store.state.preferences.enableOnScreenJoystickRight;
  ...
  onPreferenceChange() {
    const newEnableLeft = true; //window.APP.store.state.preferences.enableOnScreenJoystickLeft;
    const newEnableRight = true; //window.APP.store.state.preferences.enableOnScreenJoystickRight;
  ...
  onMoveJoystickChanged(event, joystick) {
    ...
    const force = joystick.force < 1.5 ? joystick.force : 1.5;
    this.displacement.set(Math.cos(angle), 0, Math.sin(angle)).multiplyScalar(joystick.force * 1.85); //change points
    this.moving = true;
  },

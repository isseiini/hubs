...
AFRAME.registerComponent("hanabi-animation", {
  ...
  init() {
    ...
    if (arr1.indexOf(room_name) !== -1 || arr3.indexOf(room_name) !== -1) {
      ...
      this.HanabiMesh.position.set(0, -0.3, 0.5);
    }
    if (!this.isLocalPlayer) {
      this.HanabiMesh.position.set(0, -0.3, 1.4);
    }
...
AFRAME.registerComponent("pen", {
  ...
  remove() {
    ...
    const AirCanonAction = document.getElementById("avatar-rig").getElementsByClassName(".aircanon")[0];

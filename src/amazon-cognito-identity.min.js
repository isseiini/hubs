...
!(function(e, t) {
  "object" == typeof exports && "object" == typeof module
    ? (module.exports = t(require("aws-sdk/global"), require("aws-sdk/clients/cognitoidentityserviceprovider")))
    : "function" == typeof define && define.amd
      ? define(["aws-sdk/global", "aws-sdk/clients/cognitoidentityserviceprovider"], t)
      : "object" == typeof exports
        ? (exports.AmazonCognitoIdentity = t(
            require("aws-sdk/global"),
            require("aws-sdk/clients/cognitoidentityserviceprovider")
          ))
        : (e.AmazonCognitoIdentity = t(e.AWSCognito, e.AWSCognito.CognitoIdentityServiceProvider));
})(this, function(e, t) {
  return (function(e) {
    function t(i) {
        ...
        l = (function() {
          ...
          return (
            ...
            (e.prototype.getPasswordAuthenticationKey = function(e, t, n, i, s) {
              ...
              if (((this.UValue = this.calculateU(this.largeAValue, n)), this.UValue.equals(a.default.ZERO)))
    ...
    function(e, t) {
          ...
          a < 0
            ...
            : ((o = !1),
              0 == r
                ? (this[this.t++] = a)
                : r + i > this.DB
                  ? ((this[this.t - 1] |= (a & ((1 << (this.DB - r)) - 1)) << r), (this[this.t++] = a >> (this.DB - r)))
                  : (this[this.t - 1] |= a << r),
              (r += i),
              r >= this.DB && (r -= this.DB));
        }
      ...
      function p(e) {
        ...
        if (r-- > 0)
          for (u < this.DB && (n = this[r] >> u) > 0 && ((s = !0), (o = a(n))); r >= 0; )
            u < t
              ? ((n = (this[r] & ((1 << u) - 1)) << (t - u)), (n |= this[--r] >> (u += this.DB - t)))
              : ((n = (this[r] >> (u -= t)) & i), u <= 0 && ((u += this.DB), --r)),
              n > 0 && (s = !0),
              s && (o += a(n));
        return s ? o : "0";
      }
      ...
      function E(e) {
        ...
        for (n = 0; n < t.t - 1; ++n) {
          ...
          (e[n + t.t] += t.am(n + 1, 2 * t[n], e, 2 * n + 1, i, t.t - n - 1)) >= t.DV &&
      ...
      function j(e, t, n) {
        ...
        for (o = m(e[v]) - 1; v >= 0; ) {
          for (
            o >= l
              ? (p = (e[v] >> (o - l)) & f)
              : ((p = (e[v] & ((1 << (o + 1)) - 1)) << (l - o)), v > 0 && (p |= e[v - 1] >> (this.DB + o - l))),
              c = s;
            0 == (1 & p);
              ...
              this.getUserContextData() && (s.UserContextData = this.getUserContextData()),
                this.client.makeUnauthenticatedRequest("initiateAuth", s, function(e, i) {
                  ...
                  return "CUSTOM_CHALLENGE" === s
                    ...
                    : ((n.signInUserSession = n.getCognitoUserSession(i.AuthenticationResult)),
                      n.cacheTokens(),
                          ...
                          var a = s.getNowString(),
                            u = o.util.crypto.hmac(
                              ...
                              o.util.buffer.concat([
                                new o.util.Buffer(n.pool.getUserPoolId().split("_")[1], "utf8"),
                              ...
                              if ("NEW_PASSWORD_REQUIRED" === o) {
                                ...
                                if (
                                  (s.ChallengeParameters &&
                                    ((r = JSON.parse(s.ChallengeParameters.userAttributes)),
                      ...
                      (i.verifierDevices = r.PasswordVerifier),
                        ...
                        i.client.makeUnauthenticatedRequest(
                          ...
                          function(t, s) {
                            return t
                              ? n.onFailure(t)
                              : ((i.deviceKey = e.AuthenticationResult.NewDeviceMetadata.DeviceKey),
                                i.cacheDeviceKeyAndPassword(),
                                s.UserConfirmationNecessary === !0
                                  ? n.onSuccess(i.signInUserSession, s.UserConfirmationNecessary)
                      ...
                      n.getPasswordAuthenticationKey(t.deviceKey, t.randomPassword, c, l, function(n, s) {
                        ...
                        t.getUserContextData() && (h.UserContextData = t.getUserContextData()),
                          t.client.makeUnauthenticatedRequest("respondToAuthChallenge", h, function(n, i) {
                            return n
                              ? e.onFailure(n)
                              : ((t.signInUserSession = t.getCognitoUserSession(i.AuthenticationResult)),
                                t.cacheTokens(),
            ...
            (e.prototype.sendMFACode = function(e, t, n) {
              ...
              this.getUserContextData() && (a.UserContextData = this.getUserContextData()),
                this.client.makeUnauthenticatedRequest("respondToAuthChallenge", a, function(e, n) {
                  ...
                  if (
                    ((i.signInUserSession = i.getCognitoUserSession(n.AuthenticationResult)),
                    i.cacheTokens(),
                          ...
                          function(e, s) {
                            return e
                              ...
                              : ((i.deviceKey = n.AuthenticationResult.NewDeviceMetadata.DeviceKey),
                                i.cacheDeviceKeyAndPassword(),
                                s.UserConfirmationNecessary === !0
                                  ? t.onSuccess(i.signInUserSession, s.UserConfirmationNecessary)
              ...
              this.getUserContextData() && (a.UserContextData = this.getUserContextData()),
                this.client.makeUnauthenticatedRequest("initiateAuth", a, function(i, s) {
                  ...
                  if (s) {
                    ...
                    return (
                      Object.prototype.hasOwnProperty.call(o, "RefreshToken") || (o.RefreshToken = e.getToken()),
              ...
              this.getUserContextData() && (s.UserContextData = this.getUserContextData()),
                this.client.makeUnauthenticatedRequest("respondToAuthChallenge", s, function(i, s) {
                  return i
                    ...
                    : ((n.Session = s.Session),
                      "SMS_MFA" === e
                        ? t.mfaRequired(s.challengeName, s.challengeParameters)
                        : "SOFTWARE_TOKEN_MFA" === e
                          ? t.totpRequired(s.challengeName, s.challengeParameters)
                          : void 0);
                });
            }),
                    ...
                    function(e, t) {
                      ...
                      i.getUserContextData() && (o.UserContextData = i.getUserContextData()),
                        i.client.makeUnauthenticatedRequest("respondToAuthChallenge", o, function(e, t) {
                          return e
                            ? n.onFailure(e)
                            : ((i.signInUserSession = i.getCognitoUserSession(t.AuthenticationResult)),
                              i.cacheTokens(),
                              n.onSuccess(i.signInUserSession));
                        });
                    }
        ...
        function t(n) {
          function i(t, s, o) {
            ...
            if ("undefined" != typeof document) {
              ...
              t || (r = {});
              for (
                var l = document.cookie ? document.cookie.split("; ") : [], h = /(%[0-9A-Z]{2})+/g, f = 0;
                f < l.length;
                f++
              ) {
                var d = l[f].split("="),
                ...
                try {
                  ...
                  if (((p = n.read ? n.read(p, g) : n(p, g) || p.replace(h, decodeURIComponent)), this.json))
                    try {
                      p = JSON.parse(p);
                    } catch (e) {}
                  if (t === g) {
